...
class ArticlesViewModel: ObservableObject {
   ...
   // private let coreDataService = CoreDataService
    ...
    // Main function to fetch articles based on the provided parameters
    ...
    https://newsapi.org/v2/everything?q=apple&from=2024-10-31&to=2024-10-31&sortBy=popularity&apiKey=20c2eab9e362409fa8c33473d8b7c86e
        */
        ...
        // Call the network service with the constructed URL
        networkService.fetchArticles(from: urlString)
            ...
            .sink(receiveCompletion: { [weak self] completion in
                ...
                self?.saveArticlesToCoreData(articles)
            })
            .store(in: &cancellables)
    }

    private func saveArticlesToCoreData(_ articles: [Article]) {
        // Save articles to Core Data using the coreDataService
